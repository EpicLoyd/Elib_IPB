...
$size = 48;//isset($_GET['s']) ? max(8, min(250, $_GET['s'])) : 48;
...
class public_elib_mcskin extends class_elib_core{

public function get_skin($user = 'char'){
...
public function GetImage($user = 'char'){
...
imagecopyresized($av, $im, 0, 0, $x['f'], $size, $size, 8, 8);         // Face
